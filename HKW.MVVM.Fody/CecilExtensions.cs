...
public static class CecilExtensions
{
    ...
    public static FieldReference BindDefinition(
    ...
    public static AssemblyNameReference? FindAssembly(
        this ModuleDefinition currentModule,
        string assemblyName
    )
    {
    ...
    public static TypeReference FindType(
        this ModuleDefinition currentModule,
        string @namespace,
        string typeName,
